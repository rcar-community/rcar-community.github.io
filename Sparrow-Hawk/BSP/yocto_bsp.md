...
1. Download binary from GitHub
   ...
   * BSP(either of the following BSP)
      * In case of BSP: [core-image-minimal-sparrow-hawk.rootfs.wic.gz](https://github.com/rcar-community/meta-sparrow-hawk/releases/download/v2025-11-28/core-image-minimal-sparrow-hawk.rootfs.wic.gz)
      * In case of BSP + 3D Graphics: [core-image-weston-sparrow-hawk.rootfs.wic.gz](https://github.com/rcar-community/meta-sparrow-hawk/releases/download/v2025-11-28/core-image-weston-sparrow-hawk.rootfs.wic.gz)
{:start="1"}
...
4. Test camera
   1. Display Output(Need to connect Display)
      ...
      **minimal: Raspberry Pi Camera V2 and Raspberry Pi Camera V3(J1 and J2)**
      ...
      cam -c 2 -C -D
      ```
      If you connect a Raspberry Pi Touch Display, it will take precedence, so execute the following command.
      ```bash
